...
mlp = MLP(num_hidden_units=300, alpha=.05, lambda_penalty=0.0001, activation="sigmoid", random_seed=1234)
mlp.fit(x_train, y_train, epochs=5000, batch_size=90000, pct_validation=.1)
